        ...
        <div className="flex justify-end mb-6" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
          ...
          >
            <div className="flex justify-between text-slate-600">
              <span>Subtotal:</span>
              <span className="font-bold text-slate-800">{businessInfo.currency} {grossSubtotal.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 2 })}</span>
            </div>
            ...
            {totalDiscountsCombined > 0 && (
              <div className="flex justify-between text-rose-600 font-medium">
                ...
                <span>-{businessInfo.currency} {totalDiscountsCombined.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 2 })}</span>
              </div>
            )}
